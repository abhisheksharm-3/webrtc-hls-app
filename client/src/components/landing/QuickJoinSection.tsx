...
export function QuickJoinSection() {
  const { roomId, setRoomId, handleJoinRoom, handleWatchRoom } =
    useRoomActions();
          ...
          <div className="flex flex-col items-center gap-8">
            <div>
              ...
              <p className="max-w-md text-lg text-muted-foreground">
                Jump right into an existing stream. Just paste your code below
                to get started.
              </p>
            </div>
            ...
            <form
              ...
              className="flex w-full max-w-md flex-col gap-4 items-center"
            >
