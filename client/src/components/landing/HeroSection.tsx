...
const primaryButtonStyles = "group cursor-pointer h-14 w-full sm:w-auto px-8 text-lg font-semibold transition-all duration-300 ease-in-out bg-primary text-primary-foreground hover:bg-primary/90 hover:scale-105 shadow-[0_0_20px_theme(colors.primary/30%)] hover:shadow-[0_0_40px_theme(colors.primary/50%)]";
const secondaryButtonStyles = "h-14 cursor-pointer w-full sm:w-auto px-8 text-lg font-semibold transition-all duration-300 ease-in-out bg-white/5 border-white/10 text-foreground hover:bg-white/10 hover:border-white/20 hover:scale-105 backdrop-blur-md";
    ...
    <section className="relative min-h-screen overflow-hidden bg-background">
      ...
      <div className="relative z-20 flex min-h-screen items-center px-4 py-28 md:px-8 sm:py-36">
        <div className="mx-auto max-w-5xl text-center">
          <Badge
            variant="secondary"
            className="mb-8 px-4 py-2 text-sm backdrop-blur-md bg-white/5 border-white/10 shadow-lg"
          >
          ...
          <div className="mb-24 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            <Button onClick={handleCreateRoom} size="lg" className={primaryButtonStyles}>
            ...
            >
              <Button variant="outline" size="lg" className={secondaryButtonStyles}>
