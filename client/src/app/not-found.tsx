...
const FeatureHighlightCard = ({
  ...
  <div className="group text-center">
    ...
    <p className="font-mono text-xs uppercase tracking-wider text-muted-foreground">{subtitle}</p>
  </div>
);
      ...
      <main className="relative z-20 flex min-h-screen items-center px-4 py-28 md:px-8">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mb-12 max-w-2xl text-lg leading-relaxed text-muted-foreground sm:text-xl">
            The page you&apos;re looking for seems to have drifted away. Don&apos;t worry, we can guide you back to familiar territory.
          </p>
